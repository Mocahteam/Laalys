...
{ 
	// répertoire de base pour le chargement des fichiers (réseau complet, réseau filtré, transitions, traces)
	String adressereseau = "C:\\Users\\auzende\\Desktop\\Laalys\\Trunk\\LaalysV9\\bin\\exemples\\";
	
	// les répertoires de sauvegarde
	// répertoire de sauvegarde des fichiers du réseau de Petri que l'on a filtrés soi-même
...
//////////////////////////////////////////////////////////////////
		...
		JLabel jLabel1d =new JLabel("<html><b>OPTION FACULTATIVE : créer un réseau filtré</b></html>");
		...
		reseau1a3 = new JButton("b. Générer le réseau filtré");
...
//////////////////////////////////////////////////////////////////
	...
	public void actionPerformed(ActionEvent e) { 
		...
		// en fait on va recharger le même réseau complet
		// mais cette fois pour filtrer le XML associé avant de le réenregister sous un autre nom
		// on l'appelle fullPn_travail
			...
			// on choisit une trace experte pour filtrer le réseau fullPn_travail
			sf = new SelectionFichier();
			...
			// à partir du XML réseau complet déjà chargé avec fullPn_travail
			...
			// on arrive sur le deuxième onglet
			...
			if (model4.getSize() != 0) {				
				...
				try{		            
			          ...
			          // contenu à écrire récupération de value1 complété par les labels
					ITraces itraces = new Traces();			
